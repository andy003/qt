...
void subsessionAfterPlaying(void* clientData);  // called when a stream's subsession (e.g., audio or video substream)
                                                // ends
...
int main(int argc, char** argv)
{
  ...
  // This function call does not return, unless, at some point in time, "eventLoopWatchVariable" gets set to something
  // non-zero.

  return 0;

  // If you choose to continue the application past this point (i.e., if you comment out the "return 0;" statement
  // above), and if you don't intend to do anything more with the "TaskScheduler" and "UsageEnvironment" objects, then
